...
DataService.prototype.createPromise = function (pdbIdArr, apiNameList, bestChainId) {

    var apiUrls = this.constApiUrls;
    ...
    var promises = apiNameList.map(function (apiUrlKey) {
        ...
        if (apiUrlKey === 'uniProtApiUrl') {
            ...
            return bulkPromise;
        } else if (apiUrlKey == 'residueListing'){
...
DataService.prototype.createMultiPromise = function (pdbIdArr, apiNameList, bestChainId) {
...
DataService.prototype.combinedDataGrabber = function (arrayOfPromises, pdbIdList, apiNameList, postprocess) {
...
DataService.prototype.combineData = function(arrayOfPromises, pdbId, apiNameList) {
...
DataService.prototype.sortMappingFragments = function (property) {
    var sortOrder = 1;
    if (property[0] === "-") {
        sortOrder = -1;
...
DataService.prototype.checkUniportGapProbability = function (mappingData) {
